...
latex_documents = [
    (master_doc, 'HEPCrawl.tex', 'HEPCrawl Documentation',
     'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'hepcrawl', 'HEPCrawl Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HEPCrawl', 'HEPCrawl Documentation',
     author, 'HEPCrawl', 'One line description of project.',
     'Miscellaneous'),
]
